...
public class Main {
    ...
    private static void  printFirstMenu() {
        System.out.println("-------------------------------------------");
        System.out.println("Выберите менеджер для тестирования:");
        System.out.println("1 - Менеджер, работающий с файлом.");
        System.out.println("2 - Менеджер, работающий с оперативной памятью.");
